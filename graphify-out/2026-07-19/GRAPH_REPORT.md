# Graph Report - Tunebad  (2026-07-17)

## Corpus Check
- 250 files · ~267,608 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1510 nodes · 3527 edges · 87 communities (76 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9729eafd`
...
### Community 9 - "lufs.ts"
Cohesion: 0.19
Nodes (21): CamelotWheel(), CODE_TO_KEY, point(), segmentPath(), SEGMENTS, shortKey(), ALL_CODES, CamelotWheelPage() (+13 more)
...
Cohesion: 0.11
Nodes (35): HeicTool(), ResultRow, Status, FileDropSection(), ImageDimensionError, ImageFormatPicker(), ImageTool(), ImageToolMode (+27 more)
...
Cohesion: 0.24
Nodes (10): generateMetadata(), generateStaticParams(), generateMetadata(), hubHref(), HubPagination(), keyHubHref(), keyHubMeta(), KeyHubPage() (+2 more)
...
Cohesion: 0.10
Nodes (34): DropZone(), ConverterView(), LocalFileConverter(), Status, PlaylistBatch(), FormatPicker(), FORMATS, OutputFormat (+26 more)

### Community 32 - "AnalysisResult"
Cohesion: 0.15
Nodes (17): AnalysisSummary(), MetricCardProps, FileMetaPill(), RecentRow, RecentStrip(), ResultsTable(), STAGE_ROW_LABELS, SimilarSong (+9 more)
...
Cohesion: 0.13
Nodes (15): metadata, FILE_TOOLS, ToolsHub(), CopyrightBody(), SECTIONS, LanguageMenu(), detectLocale(), Dict (+7 more)
...
Cohesion: 0.10
Nodes (36): AudioEffectResult, AudioEffectTool(), Status, AudioFormatPicker(), AudioOutputFormat, MP3_BITRATES, AudioJoinerTool(), nextId() (+28 more)
...
Cohesion: 0.24
Nodes (8): FAQS, metadata, PlaylistAnalyzerPage(), MinimalFooter(), KNOWN_HREFS, LINKS, ToolPageNav(), I18nProvider()
...
Cohesion: 0.14
Nodes (22): Home(), BpmHubPage(), generateMetadata(), generateStaticParams(), parseBpm(), tempoContext(), SongsPage(), countSongs() (+14 more)
...
- **Why does `RemixStudio()` connect `analysis.ts` to `AnalysisResult`, `route.ts`, `TunebadApp`, `NavTabs.tsx`, `ToolFaq.tsx`, `AnalyzerPanel`, `ToolPageShell.tsx`, `mp3-encoder.ts`, `useTunebad`, `ReverbEq.tsx`?**
  _High betweenness centrality (0.252) - this node is a cross-community bridge._
- **Why does `base()` connect `analysis.ts` to `ffmpeg-core.js`?**
  _High betweenness centrality (0.243) - this node is a cross-community bridge._
- **Why does `useI18n()` connect `ReverbEq.tsx` to `analysis.ts`, `route.ts`, `TunebadApp`, `layout.tsx`, `VideoTool.tsx`, `link-analysis.ts`, `ToolFaq.tsx`, `ToolPageShell.tsx`, `backends.ts`, `VideoTool.tsx`, `useAnalyzer.ts`, `AnalysisResult`, `page.tsx`, `lufs.ts`, `AnalyzerPanel`, `mp3-encoder.ts`, `lufs.ts`, `DelayCalculator.tsx`, `formatBytes`, `useHistory.ts`, `route.ts`, `NavTabs.tsx`, `AnalyzerPanel`, `NightcoreTool.tsx`, `useTunebad`?**
