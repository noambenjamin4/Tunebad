...
## Corpus Check
- 229 files · ~239,257 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1361 nodes · 3207 edges · 77 communities (67 shown, 10 thin omitted)
...
### Community 9 - "lufs.ts"
Cohesion: 0.12
Nodes (23): GET(), PlaylistLookupTrack, querySchema, runPool(), sleep(), SourceTrack, POST(), spotifyRequestSchema (+15 more)

### Community 10 - "VideoTool.tsx"
Cohesion: 0.25
Nodes (12): GET(), idSchema, querySchema, searchSchema, resolveTrack(), cleanSongTitle(), DeezerPreviewMatch, findDeezerPreview() (+4 more)

### Community 11 - "link-analysis.ts"
Cohesion: 0.11
Nodes (33): metadata, HeicTool(), ResultRow, Status, ImageDimensionError, ImageTool(), ImageToolMode, ResultRow (+25 more)
...
Cohesion: 0.12
Nodes (18): metadata, metadata, AUDIO_FORMATS, MediaConvertTool(), MP3_BITRATES, Status, VIDEO_FORMATS, useUnloadGuard() (+10 more)
...
Cohesion: 0.16
Nodes (17): ConverterView(), LocalFileConverter(), Status, FormatPicker(), FORMATS, OutputFormat, QUALITIES, Quality (+9 more)

### Community 32 - "AnalysisResult"
Cohesion: 0.31
Nodes (7): ALL_CODES, CamelotHubPage(), CODE_TO_KEY, generateMetadata(), parseCode(), camelot, readSongsByCamelotCode()
...
Cohesion: 0.23
Nodes (11): Footer(), TOOL_LINKS, HISTORY_TAB, NavTabs(), TABS, TopBar(), TunebadContext, VIEW_TO_PATH (+3 more)
...
Cohesion: 0.08
Nodes (20): baloo2, geistMono, geistSans, metadata, STRUCTURED_DATA, viewport, ClientErrorReporter(), report() (+12 more)
...
Cohesion: 0.14
Nodes (23): AnalysisSummary(), MetricCardProps, DropZone(), FileMetaPill(), RecentRow, RecentStrip(), ResultsTable(), SimilarSong (+15 more)

### Community 63 - "media-url.ts"
Cohesion: 0.21
Nodes (14): MetronomeCard(), EXPORT_TARGETS, formatDb(), LoudnessPanel(), LoudnessWorkerResult, resampleTo48k(), toneFor(), clampBpm() (+6 more)

### Community 64 - "page.tsx"
Cohesion: 0.17
Nodes (12): PlaylistBatch(), BatchOptions, PlaylistItem, PlaylistRowPhase, PlaylistRowState, rowLabel(), usePlaylistBatch(), useYouTubeJob() (+4 more)
...
Cohesion: 0.18
Nodes (7): AnalyzerPanel(), parseTimestamp(), YouTubeDownloader(), GlobalDropCatcher(), TunebadContextValue, VIEWS_WITH_OWN_INTAKE, AnalysisResult

### Community 71 - "delay.ts"
Cohesion: 0.17
Nodes (18): TapTempoCard(), DelayCalculator(), formatHz(), formatMs(), PRESET_NAME_KEYS, HistoryPanel(), useTunebad(), useTapTempo() (+10 more)

### Community 72 - "delay.ts"
Cohesion: 0.21
Nodes (12): AudioJoinerTool(), nextId(), QueuedFile, Status, Transition, TRANSITION_LABELS, channelDataFor(), JoinOptions (+4 more)

### Community 73 - "page.tsx"
Cohesion: 0.27
Nodes (7): AudioEffectResult, Status, AudioFormatPicker(), AudioOutputFormat, MP3_BITRATES, FileDrop(), useFileDrop()
...
- **Why does `useI18n()` connect `usePlaylistBatch.ts` to `analysis.ts`, `RemixStudio.tsx`, `ytdlp.ts`, `link-analysis.ts`, `ToolFaq.tsx`, `CutterPanel.tsx`, `ToolPageShell.tsx`, `backends.ts`, `VideoTool.tsx`, `icons.tsx`, `ReverbEq.tsx`, `layout.tsx`, `LoudnessPanel.tsx`, `downloadBlob`, `useHistory.ts`, `rate-limit.ts`, `MetronomeCard.tsx`, `media-url.ts`, `page.tsx`, `media-url.ts`, `spotify-playlist.ts`, `ToolsHub.tsx`, `delay.ts`, `delay.ts`, `page.tsx`, `page.tsx`, `NightcoreTool.tsx`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `validateMediaUrl()` connect `downloadBlob` to `audio-joiner.ts`, `ToolsHub.tsx`, `VideoTool.tsx`, `AnalyzerPanel.tsx`, `ReverbEq.tsx`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `validateSpotifyUrl()` connect `downloadBlob` to `lufs.ts`, `VideoTool.tsx`, `ToolsHub.tsx`, `ReverbEq.tsx`?**
