...
## Corpus Check
- 265 files · ~285,695 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1610 nodes · 3866 edges · 89 communities (75 shown, 14 thin omitted)
...
Cohesion: 0.11
Nodes (29): applyEffectParams(), applyReverbEqParams(), automatedOutputDuration(), baseEffectiveSpeed(), buildEffectChain(), buildParallelConvolvers(), buildRemixChain(), buildRemixGraph() (+21 more)
...
Cohesion: 0.10
Nodes (35): AbMode, AudioMasteringTool(), differenceCurve(), GENRE_LABELS, GENRE_ORDER, GENRE_PRESETS, GenreKey, GenrePreset (+27 more)
...
Cohesion: 0.17
Nodes (22): clamp(), computeResponseDb(), curveDbAt(), curvePath(), dbOf(), EqNodeDef, EqNodeId, Geometry (+14 more)
...
Cohesion: 0.16
Nodes (17): FileDrop(), EXPORT_TARGETS, formatDb(), LoudnessPanel(), LoudnessWorkerResult, resampleTo48k(), toneFor(), useFileDrop() (+9 more)
...
Cohesion: 0.22
Nodes (18): DragState, Timeline(), assignDisplayRows(), clipDuration(), clipTimelineEnd(), FadePoint, clampZoom(), rulerStepSeconds() (+10 more)
...
Cohesion: 0.11
Nodes (28): ClipCanvas(), bufferKey(), bufferMap, decodedBytes(), DEFAULT_PARAMS, EFFECT_OPTIONS, makeClipId(), REVERB_TYPE_OPTIONS (+20 more)

### Community 64 - "downloadBlob"
Cohesion: 0.14
Nodes (10): RemixChain, RemixGraph, renderRemix(), ActiveGraph, StudioEngine, exportStudioMix(), renderTimeline(), computeClipSchedule() (+2 more)
...
Cohesion: 0.06
Nodes (54): applyFades(), CutterPanel(), Status, clamp(), TrimWaveform(), ZOOM_LEVELS, ZoomLevel, barsFromChannels() (+46 more)
...
- **Why does `RemixStudio()` connect `layout.tsx` to `AnalysisResult`, `analysis.ts`, `downloadBlob`, `route.ts`, `ffmpeg-core.js`, `TunebadApp`, `CutterPanel.tsx`, `getEnvStrings`, `VideoTool.tsx`, `lufs.ts`, `DelayCalculator.tsx`, `ReverbEq.tsx`, `CamelotHubPage.tsx`?**
  _High betweenness centrality (0.285) - this node is a cross-community bridge._
- **Why does `base()` connect `ffmpeg-core.js` to `layout.tsx`?**
  _High betweenness centrality (0.277) - this node is a cross-community bridge._
- **Why does `useI18n()` connect `ReverbEq.tsx` to `route.ts`, `TunebadApp`, `layout.tsx`, `rate-limit.ts`, `link-analysis.ts`, `AnalyzerPanel.tsx`, `CutterPanel.tsx`, `ToolPageShell.tsx`, `backends.ts`, `VideoTool.tsx`, `VideoTool.tsx`, `useAnalyzer.ts`, `AnalysisResult`, `audio-joiner.ts`, `page.tsx`, `lufs.ts`, `lufs.ts`, `DelayCalculator.tsx`, `formatBytes`, `delay.ts`, `CamelotHubPage.tsx`, `page.tsx`, `page.tsx`, `getEnvStrings`, `page.tsx`?**
