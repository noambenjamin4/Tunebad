...
## Corpus Check
- 229 files · ~239,225 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1359 nodes · 3205 edges · 79 communities (67 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7901697c`
...
6. `RemixStudio()` - 21 edges
7. `AudioMasteringTool()` - 20 edges
8. `DictKey` - 19 edges
9. `fs` - 19 edges
10. `ToolFaq()` - 18 edges
...
Cohesion: 0.22
Nodes (10): POST(), resultSchema, GET(), GET(), GET(), querySchema, isAllowedPreviewUrl(), readRecentAnalyses() (+2 more)

### Community 8 - "dependencies"
Cohesion: 0.05
Nodes (38): dependencies, essentia.js, fflate, @ffmpeg/core, @ffmpeg/ffmpeg, ffmpeg-static, heic-to, next (+30 more)

### Community 9 - "lufs.ts"
Cohesion: 0.20
Nodes (8): GET(), playlistRequestSchema, POST(), validatePlaylistUrl(), IMPORTANT: this module reads server-only secrets and must never be, fetchYouTubeTracklist(), YouTubeTracklistItem, YouTubeTracklistResult

### Community 10 - "VideoTool.tsx"
Cohesion: 0.16
Nodes (19): GET(), idSchema, querySchema, searchSchema, querySchema, resolveTrack(), runPool(), sleep() (+11 more)
...
Cohesion: 0.17
Nodes (17): CONTENT_TYPE_BY_FORMAT, contentDisposition(), GET(), GET(), Backend, backendForJob(), BackendTag, homeBackend() (+9 more)
...
Cohesion: 0.13
Nodes (31): CamelotWheel(), CODE_TO_KEY, point(), segmentPath(), SEGMENTS, shortKey(), ALL_CODES, CamelotWheelPage() (+23 more)
...
Cohesion: 0.23
Nodes (14): displayTitle(), generateMetadata(), generateStaticParams(), metaTitle(), pct(), SongPage(), SongPageInner(), tempoFeel() (+6 more)
...
Cohesion: 0.13
Nodes (22): ConverterView(), LocalFileConverter(), Status, FormatPicker(), FORMATS, OutputFormat, QUALITIES, Quality (+14 more)

### Community 32 - "AnalysisResult"
Cohesion: 0.23
Nodes (11): Home(), Image(), loadFont(), size, countSongs(), DeezerPreviewMatch, isLinkAnalysisConfigured, PreviewMatch (+3 more)
...
Cohesion: 0.08
Nodes (21): FAQS, metadata, PlaylistAnalyzerPage(), FAQS, metadata, ROWS, VsPage(), FAQ_JSON_LD (+13 more)
...
Cohesion: 0.18
Nodes (15): ensureAnonSession(), entryFromRemoteRow(), entryFromResult(), readLocal(), RemoteRow, useHistory(), writeLocal(), YouTubeJobState (+7 more)

### Community 58 - ".t"
Cohesion: 0.19
Nodes (13): POST(), reportSchema, POST(), spotifyRequestSchema, POST(), runningJobCount(), allow(), allowEnumerate() (+5 more)
...
Cohesion: 0.15
Nodes (20): AnalysisSummary(), MetricCardProps, DropZone(), FileMetaPill(), RecentRow, RecentStrip(), ResultsTable(), SimilarSong (+12 more)

### Community 63 - "media-url.ts"
Cohesion: 0.23
Nodes (12): EXPORT_TARGETS, formatDb(), LoudnessPanel(), LoudnessWorkerResult, resampleTo48k(), toneFor(), decodeAudioFileCached(), keyFor() (+4 more)
...
### Community 70 - "ToolsHub.tsx"
Cohesion: 0.23
Nodes (5): AnalyzerPanel(), GlobalDropCatcher(), TunebadContextValue, VIEWS_WITH_OWN_INTAKE, AnalysisResult
...
## Knowledge Gaps
- **370 isolated node(s):** `metadata`, `resultSchema`, `reportSchema`, `querySchema`, `idSchema` (+365 more)
...
- **Why does `useI18n()` connect `usePlaylistBatch.ts` to `analysis.ts`, `RemixStudio.tsx`, `ytdlp.ts`, `TunebadApp`, `link-analysis.ts`, `CutterPanel.tsx`, `ToolPageShell.tsx`, `backends.ts`, `VideoTool.tsx`, `icons.tsx`, `ReverbEq.tsx`, `delay.ts`, `LoudnessPanel.tsx`, `downloadBlob`, `useHistory.ts`, `useHistory.ts`, `rate-limit.ts`, `MetronomeCard.tsx`, `media-url.ts`, `page.tsx`, `media-url.ts`, `spotify-playlist.ts`, `ToolsHub.tsx`, `delay.ts`, `page.tsx`, `page.tsx`, `NightcoreTool.tsx`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `validateMediaUrl()` connect `downloadBlob` to `AnalysisResult`, `.t`, `AnalyzerPanel.tsx`, `ReverbEq.tsx`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `validateSpotifyUrl()` connect `downloadBlob` to `AnalysisResult`, `lufs.ts`, `VideoTool.tsx`, `.t`, `ReverbEq.tsx`?**
