...
const ja: Record<keyof typeof en, string> = {
  ...
  "remix.effectRadio": "ラジオ",
  "remix.effectMegaphone": "メガホン",
  "remix.record": "録音",
  ...
  "remix.recordingReadyReadout": "録音済み · {time} · {count} 操作",
  "remix.discardRecording": "録音を破棄",
  ...
  "remix.exportRemixFormat": "リミックスを {format} で書き出す",
