const en = {
  ...
  "landing.tour7Title": "Mix songs on a timeline",
  "landing.tour7Body": "Put several songs side by side, drag one over the end of another for a beat switch, and export the mix. Waveforms, fades, live effects, all in the browser.",
  "landing.tour7Link": "Open the DAW",
  "landing.faq13Q": "How do I mix two songs together, like a beat switch?",
  "landing.faq13A": "Put both on one timeline and let them overlap. In the TuneBad DAW you drop the songs in, drag the second one left until it sits over the end of the first, and both keep playing through the overlap, which is what a beat switch actually is. Crossfade shapes the handover, Match stretches a clip onto the project tempo if the two disagree, and the export is the mix you just heard.",
  "landing.faq13Link": "Open the DAW",
  ...
  "studio.meterHint": "Master output level — the light latches when the mix goes over",
  "studio.mute": "Mute",
  "studio.introA": "Overlap two songs on one timeline — that is a beat switch.",
  "studio.introB": "It finds the tempo, draws the grid, and matches clips that disagree.",
  "studio.introC": "Ride the speed and effects while it plays, then export exactly what you heard.",
  "studio.faq4Q": "The two songs are different tempos — now what?",
  "studio.faq4A": "Every clip gets its tempo detected and shown. When it does not match the project, a Match button appears: it stretches that clip to the project tempo without changing its pitch, then slides it so its downbeat lands on the grid. The BPM is editable, with one-click halve and double, because tempo detection is an estimate and gets the octave wrong on fast tracks.",
  "studio.faq5Q": "Will I lose my work if I close the tab?",
  "studio.faq5A": "No. The arrangement and the songs themselves are saved in this browser as you work, and the timeline comes back when you return. Clear session wipes it whenever you want. Nothing is uploaded — the files never leave your device.",
  ...
  "studio.seoHeading": "What the TuneBad DAW is",
  "studio.seoLede": "A DAW is the software musicians arrange audio in. This is a free one that runs in a browser tab: put up to 12 songs on a single timeline, see every waveform, drag one so it overlaps another, cut and split anywhere, then export as MP3 or WAV. Nothing is uploaded — the audio is decoded and mixed on your own machine.",
  "studio.seoLede2": "It exists for beat switches. Two songs playing over each other for a few bars is the whole trick, and it needs a timeline you can see — which is the one thing a single-file editor cannot give you.",
  "studio.howHeading": "How to make a beat switch",
  "studio.how1": "Drop two songs in. They land one after the other, and each draws its own waveform.",
  "studio.how2": "Drag the second one left until it sits over the end of the first. Both keep playing through the overlap — that is the switch.",
  "studio.how3": "Press Crossfade to fade one out as the other comes in, or type your own fade lengths. If the two tempos disagree, Match stretches the second clip onto the project grid.",
  "studio.how4": "Ride the speed, reverb and phone effects while it plays if you want the performance recorded, then export as MP3 or WAV. The file is the mix you just heard.",
  "studio.compareHeading": "Which tool do you actually need?",
  "studio.compareTool": "Tool",
  "studio.compareWhen": "Use it when",
  "studio.whenDaw": "Songs need to overlap, or you want to hear the transition before you export it.",
  "studio.whenJoiner": "Files just go one after another, with no overlap.",
  "studio.whenCutter": "One file, and you only want to keep one region of it.",
  "studio.whenRemix": "One file, and the whole thing gets the same slowed or nightcore treatment.",
  "studio.sessionFull": "Session too large to save — the arrangement is kept, the audio is not",
  "studio.clipBpm": "{bpm} BPM",
  "studio.clipLabel": "{name}, {from} to {to}, row {row}",
  "studio.fadeShape": "Fade shape",
  "studio.fadeShapeHint": "Equal power holds the level through a crossfade; linear is the plain taper",
  "studio.fadeLinear": "Linear",
  "studio.fadeEqualPower": "Equal power",
  ...
  "studio.crossfadeHint": "Fade this clip and the one it overlaps into each other, equal power",
  "studio.crossfaded": "Crossfaded over {seconds}s",
  "studio.matched": "Matched to {bpm} BPM",
  "studio.matchFailed": "Could not stretch this clip",
  "studio.grid": "Grid",
  "studio.gridHint": "Snap clips to the beat",
  "studio.bpm": "BPM",
  ...
  "studio.lockVsRecord": "Turn lock pitch off to record moves — a recorded speed sweep can only be exported tape-style.",
  "studio.loop": "Loop",
  "studio.loopHint": "Loop the transition — drag the strip above the ruler to set your own",
  "studio.loopBars": "Looping {bars} bars",
  "studio.loopLength": "Looping {seconds}s",
  "studio.follow": "Follow",
  "studio.followHint": "Keep the playhead on screen while playing",
  "studio.solo": "Solo",
  "studio.duplicate": "Duplicate",
  "studio.soloNotice": "Solo is on — the export will contain only soloed clips.",
  ...
  "studio.dropTitle": "Drop songs here to build a mix (up to {count})",
  "studio.dropMore": "Add more songs ({count} slots left)",
  "studio.decoding": "Decoding…",
  "studio.decodeFailed": "Could not decode {name}.",
  "studio.memoryFull": "That's as much audio as the browser can hold — remove a song first.",
  "studio.play": "Play",
  "studio.pause": "Pause",
  ...
  "studio.clipActions": "Clip actions",
  "studio.fadeIn": "Fade in (s)",
  "studio.fadeOut": "Fade out (s)",
  "studio.split": "Split at playhead",
  "studio.remove": "Remove clip",
  "studio.speed": "Speed",
  "studio.reverb": "Reverb",
  "studio.bass": "Bass",
  "studio.reverbType": "Reverb character",
  "studio.effect": "Effect",
  "studio.takes": "Takes",
  "studio.takeNone": "No take",
  "meta.daw.title": "Free Online DAW: Mix Multiple Songs on One Timeline",
  "toolfaq.keyBpm.q1": "Why does it show two BPMs, like \"150 or 75\"?",
  "toolfaq.keyBpm.a1": "Because plenty of songs can honestly be counted at either tempo. A half-time beat reads as 75 to one estimator and 150 to another, and neither is wrong. TuneBad shows both numbers and lets you pick the one that matches how you'd count the track.",
  "toolfaq.keyBpm.q2": "How accurate is the key and BPM detection?",
  "toolfaq.keyBpm.a2": "It runs on essentia, the same engine behind most of the popular key and BPM tools, and it measures your actual audio rather than looking the song up in a database. Key is reliable on anything with clear harmony, but a track that modulates partway through only gets one answer, and sparse or atonal music can fool it. If a number looks wrong, trust your ears.",
  "toolfaq.keyBpm.q3": "Why doesn't the key match what another site says?",
  "toolfaq.keyBpm.a3": "Estimators disagree, most often between a key and its relative minor or major, because the two share the same notes. The Camelot code makes that easier to work with: relative keys sit at the same number, so 8A and 8B still mix. If two tools disagree, play a scale over the track and pick the one that sits right.",
  "toolfaq.keyBpm.q4": "Is my file uploaded anywhere?",
  "toolfaq.keyBpm.a4": "No. The analysis runs in your browser, so the audio never leaves your device, and there's no account to make. That's also why you can analyze an unreleased mix or a bootleg that no lookup database would have.",
  "toolfaq.loudness.q1": "What LUFS should I master to for Spotify?",
  "toolfaq.loudness.a1": "Around -14 LUFS integrated is the target Spotify normalizes to, and Apple Music, YouTube, TIDAL, Amazon, and Deezer each sit at their own level. The meter measures your track with the BS.1770 standard and shows how much every one of those platforms will turn it down. Mastering louder than the target doesn't make you louder on streaming, it just earns a bigger penalty.",
  "toolfaq.loudness.q2": "What is a loudness penalty?",
  "toolfaq.loudness.a2": "It's how many dB a streaming platform turns your track down to match everything else in a listener's queue. A track measured at -8 LUFS gets roughly 6 dB taken off it on Spotify, so all the loudness you fought for in mastering disappears. What survives the turn-down is your dynamics, not your level.",
  "toolfaq.loudness.q3": "Is LUFS the same as the dB reading in my DAW?",
  "toolfaq.loudness.a3": "No. Your DAW's peak meter shows the single loudest instant in dBFS, while LUFS measures perceived loudness averaged over the whole track and weighted for how ears actually hear. A track can peak at 0 dBFS and still measure quietly in LUFS, which is why streaming services normalize by LUFS.",
  "toolfaq.loudness.q4": "Can it fix the loudness for me?",
  "toolfaq.loudness.a4": "Yes, it can normalize the track to a target loudness and export it. Understand what that does, though: it changes the level, not the mix. It won't tighten a master, and if your track is already squashed, turning it down leaves it squashed and quieter.",
  "toolfaq.cutter.q1": "How do I make a ringtone out of a song?",
  "toolfaq.cutter.a1": "Drop the file in, drag the start and end points to the section you want, add a short fade in and out, then export as MP3 or WAV. Keep it around 20 to 30 seconds. On Android that MP3 works directly; iPhone ringtones have to be .m4r files added through a computer, so there's an extra step Apple doesn't let a browser do.",
  "toolfaq.cutter.q2": "Does cutting an MP3 lose quality?",
  "toolfaq.cutter.a2": "Exporting as MP3 re-encodes the audio, so a little detail goes, the same as any MP3 pass. Export as WAV if you want the trimmed audio bit-for-bit as it was in the source. For a ringtone or a voice memo the MP3 loss is inaudible.",
  "toolfaq.cutter.q3": "Can I hear the fade before I export?",
  "toolfaq.cutter.a3": "Yes. The fade in and out are audible while you scrub the waveform, so you hear the actual result instead of guessing from a shape on screen. Click anywhere on the waveform to jump there and check the edit points.",
  "toolfaq.cutter.q4": "Is there a file size limit, and is anything uploaded?",
  "toolfaq.cutter.a4": "Nothing is uploaded. The trim and the export both run in your browser, so the file never leaves your device, and there's no account or watermark. The practical ceiling is your device's memory, so very long files behave better on a computer than on a phone.",
  "toolfaq.remix.q1": "How do I make a slowed + reverb version of a song?",
  "toolfaq.remix.a1": "Drop the track in, pull the speed down to roughly 0.75 to 0.85, pick a reverb type, then export. Most of the sound comes from those two moves. From there the parametric reverb EQ is what separates a clean edit from a muddy one.",
  "toolfaq.remix.q2": "Why does the song sound lower when I slow it down?",
  "toolfaq.remix.a2": "Because slowing audio stretches its waveform, which drops the pitch with it, exactly like playing a record at a lower speed. That coupling is the slowed aesthetic, not a bug. If you want the slower tempo without the darker pitch, raise the pitch control back up separately.",
  "toolfaq.remix.q3": "How do I make a nightcore edit instead?",
  "toolfaq.remix.a3": "Push the speed above 1.0, usually somewhere around 1.25, and the pitch rises with it. That's the whole nightcore effect. Add little or no reverb, since nightcore wants the opposite of the washed-out slowed sound.",
  "toolfaq.remix.q4": "What does the reverb EQ actually change?",
  "toolfaq.remix.a4": "It shapes the reverb tail rather than the song. Drag the bands to cut low mud out of a big hall, or roll off the top so the tail sits behind the vocal instead of hissing over it. There are five reverb types to start from, and the EQ is what makes each one usable on a specific track.",
  "toolfaq.converter.q1": "Which links can I convert to MP3?",
  "toolfaq.converter.a1": "YouTube, Spotify, SoundCloud, TikTok, Instagram, X, Bandcamp, Vimeo, Mixcloud, and Audiomack. Paste the link, pick MP3, WAV, or MP4, and download the result. There's no account, no ads, and no watermark.",
  "toolfaq.converter.q2": "Which MP3 bitrate should I pick?",
  "toolfaq.converter.a2": "320 kbps for the best quality, 192 for a good balance, 128 for the smallest file. Be realistic about the ceiling, though: the source is already a compressed stream, so 320 preserves what's there rather than restoring anything the platform threw away. Pick WAV if the file is going into an edit or a DAW.",
  "toolfaq.converter.q3": "Is this allowed?",
  "toolfaq.converter.a3": "Keep it to personal use: your own uploads, licensed material, or a track you already own. Downloading someone else's music to redistribute or monetize is on you, not on the tool. Most platforms' terms also cover this, so treat it as a personal-archive tool.",
  "toolfaq.converter.q4": "Does the link get sent to a server?",
  "toolfaq.converter.a4": "A pasted link has to be fetched for you, so that step doesn't happen on your device. A local audio file you drop in is different: it's converted in your browser and never leaves your machine. Either way there's nothing to sign up for.",
  "meta.loudness.title": "Loudness Penalty & LUFS Meter",
  "meta.loudness.description": "Free LUFS loudness meter. Check your track's loudness and see how much Spotify, Apple Music, YouTube, TIDAL, Amazon, and Deezer will turn it down.",
  "meta.pitchShifter.title": "Frequency to Note Calculator — Hz to Pitch & Cents",
  "meta.pitchShifter.description": "Convert any frequency in Hz to the nearest musical note, octave, and cents offset. Free, in your browser. To change a song's pitch, use the nightcore maker.",
  "meta.delayReverbCalculator.title": "Delay & Reverb Time Calculator",
  "meta.delayReverbCalculator.description": "Free delay and reverb time calculator. Enter a BPM and get delay times in ms and Hz from 1/1 to 1/64, plus reverb pre-delay and decay presets.",
  "meta.bpmTap.title": "BPM Tap Tempo & Metronome",
  "meta.bpmTap.description": "Tap along to find the BPM of any song, or use the built-in metronome. A simple BPM counter, tap tempo, and metronome, all in your browser.",
  "meta.playlistAnalyzer.title": "Free Playlist Analyzer: Key & BPM of Every Track",
  "meta.playlistAnalyzer.description": "Paste a Spotify or YouTube playlist link and get the key, BPM, and Camelot code for every track, in one table. Free, no signup, export to CSV.",
  "meta.camelotWheel.title": "Camelot Wheel: Interactive Harmonic Mixing Chart",
  "meta.camelotWheel.description": "A free interactive Camelot wheel. Click any of the 24 codes to see its musical key, which codes mix cleanly with it, and real analyzed songs in that key.",
  "meta.audioMastering.title": "Free Online Audio Mastering: Master a Song",
  "meta.audioMastering.description": "Master any song in your browser with EQ, glue compression, and a loudness limiter, or match a reference track's tone and loudness. Free, no upload, no sign-up.",
  "meta.nightcoreMaker.title": "Nightcore Maker: Speed Up & Pitch Up a Song Online",
  "meta.nightcoreMaker.description": "Turn any song into a nightcore edit right in your browser: speeds it up and raises the pitch together, the classic nightcore sound. Free, no upload, no sign-up.",
  "meta.bassBooster.title": "Bass Booster: Add Bass to a Song Online",
  "meta.bassBooster.description": "Boost the low end of any audio file in your browser with a low-shelf bass boost and a safety limiter so the output never clips. Free, no upload, no sign-up.",
  "meta.8dAudio.title": "8D Audio Maker: Convert Any Song to 8D Online",
  "meta.8dAudio.description": "Make an 8D audio edit that slowly pans left to right for headphones, right in your browser. Free, no upload, no sign-up.",
  "meta.audioJoiner.title": "Audio Joiner: Merge MP3 Files Online",
  "meta.audioJoiner.description": "Combine two or more audio files into one, reorder them, and export as MP3 or WAV, right in your browser. Free, no upload, no sign-up.",
  "meta.audioConverter.title": "Audio Converter: MP3, WAV, FLAC, OGG & M4A",
  "meta.audioConverter.description": "Convert FLAC to MP3, M4A to MP3, WAV, OGG, and more right in your browser. Pick the MP3 bitrate. Files never leave your device. Free, no sign-up, no ads.",
  "meta.flacToMp3.title": "FLAC to MP3 Converter (Pick the Bitrate)",
  "meta.flacToMp3.description": "Convert lossless FLAC files to MP3 at 128, 192, or 320 kbps, right in your browser. Your music never leaves your device. Free, no sign-up, no ads.",
  "meta.wavToMp3.title": "WAV to MP3 Converter (Free, In Your Browser)",
  "meta.wavToMp3.description": "Turn huge uncompressed WAV files into small MP3s at 128, 192, or 320 kbps, right in your browser. Files never leave your device. Free, no sign-up.",
  "meta.videoConverter.title": "Video Converter: MP4, WebM, MKV, MOV, AVI & More",
  "meta.videoConverter.description": "Convert AVI to MP4, MKV to MP4, WebM to MP4, MOV, FLV, or WMV right in your browser. The video never leaves your device. Free, no sign-up, no watermark.",
  "meta.compressVideo.title": "Compress Video Online (No Upload)",
  "meta.compressVideo.description": "Shrink a video to 10, 25, 50, or 100 MB right in your browser. The file never leaves your device. Free, no sign-up, no watermark.",
  "meta.compressVideoForDiscord.title": "Compress Video for Discord (Under 10MB)",
  "meta.compressVideoForDiscord.description": "Get a video under Discord's 10MB upload limit in your browser, no upload and no watermark. Presets for 10MB free tier and 50MB Nitro Basic.",
  "meta.compressVideoForWhatsapp.title": "Compress Video for WhatsApp (Under 16MB)",
  "meta.compressVideoForWhatsapp.description": "Get a video under WhatsApp's 16MB share limit in your browser, no upload and no watermark. Presets for 16, 25, and 50 MB.",
  "meta.mkvToMp4.title": "MKV to MP4 Converter (Free, In Your Browser)",
  "meta.mkvToMp4.description": "Convert MKV files from rips, OBS recordings, or downloads to MP4 right in your browser. The file never leaves your device. No watermark, no sign-up.",
  "meta.movToMp4.title": "MOV to MP4 Converter (Free, In Your Browser)",
  "meta.movToMp4.description": "Convert iPhone and QuickTime MOV videos to MP4 that plays anywhere, right in your browser. The file never leaves your device. No watermark, no sign-up.",
  "meta.imageConverter.title": "Image Converter: PNG, JPG & WebP",
  "meta.imageConverter.description": "Convert images between PNG, JPG, and WebP right in your browser. Files never leave your device. Free, no sign-up, no ads.",
  "meta.compressImage.title": "Compress Images Online",
  "meta.compressImage.description": "Shrink JPG, PNG, and WebP file sizes with a quality slider, right in your browser. Files never leave your device. Free, no sign-up.",
  "meta.resizeImage.title": "Resize Images Online",
  "meta.resizeImage.description": "Resize any image to exact pixel dimensions in your browser, with optional aspect-ratio lock. Files never leave your device. Free, no sign-up.",
  "meta.resizeImageForInstagram.title": "Resize Images for Instagram (Story, Post, Reel)",
  "meta.resizeImageForInstagram.description": "Resize any photo to Instagram's exact sizes: Story 1080x1920, square post 1080x1080, portrait 1080x1350, landscape 1080x566. Runs in your browser, free.",
  "meta.compressImageTo100kb.title": "Compress Images to 100KB (or 50KB, 200KB, 500KB)",
  "meta.compressImageTo100kb.description": "Hit an exact file-size limit: compress any image to 100KB, 50KB, 200KB, or 500KB in your browser. Great for forms and uploads with size caps. Free.",
  "meta.heicToJpg.title": "HEIC to JPG Converter: iPhone Photos Online",
  "meta.heicToJpg.description": "Convert HEIC or HEIF photos from an iPhone to JPG or PNG in your browser. No upload, no account, works on any device, including ones that can't open HEIC.",
  "meta.mergePdf.title": "Merge PDF Files Online",
  "meta.mergePdf.description": "Combine multiple PDF files into one document, in the order you choose. Runs in your browser, nothing gets uploaded. No sign-up, no ads, free.",
  "meta.splitPdf.title": "Split PDF: Extract Pages Online",
  "meta.splitPdf.description": "Pull a range of pages out of a PDF into a new file, right in your browser. Nothing gets uploaded. No sign-up, no ads, free.",
  "meta.jpgToPdf.title": "JPG to PDF Converter",
  "meta.jpgToPdf.description": "Turn JPG and PNG images into a single PDF, one page per photo. Runs in your browser, nothing gets uploaded. No sign-up, no ads, free.",
  "meta.unzipFiles.title": "Unzip Files Online (ZIP, TAR, TAR.GZ)",
  "meta.unzipFiles.description": "Open a ZIP, TAR, or TAR.GZ archive and download its contents, or bundle files into a new archive. Runs in your browser, nothing uploaded. No sign-up, free.",
  "meta.tools.title": "Free Online File Tools",
  "meta.tools.description": "Free file tools that run in your browser: convert, resize, and compress images, and more. No uploads, no sign-up, no ads.",
  "meta.daw.description": "Put up to 12 songs on one timeline, see the waveforms, drag them to overlap for a beat switch, cut and split, add live slowed + reverb and phone effects, then export as MP3 or WAV. Free, in your browser, nothing uploaded.",
  "meta.keyBpm.title": "Song Key & BPM Finder",
  "meta.keyBpm.description": "Free key and BPM finder. Paste a YouTube, Spotify, or SoundCloud link, or drop an audio file, and get the key, tempo, Camelot code, and loudness of any song.",
  "meta.slowedReverb.title": "Slowed + Reverb Maker",
  "meta.slowedReverb.description": "Make a slowed and reverb version of any song, or speed it up for a nightcore edit. Set the speed, pitch, and reverb, then export it free in your browser.",
  "meta.mp3Cutter.title": "MP3 Cutter and Ringtone Maker",
  "meta.mp3Cutter.description": "Cut MP3, WAV, and other audio files in your browser. Trim a song to the part you want, add a fade, and save it as an MP3 or WAV. Free, no upload, no signup.",
  "meta.converter.title": "YouTube & Spotify to MP3 Converter",
  "meta.converter.description": "Turn YouTube, Spotify, SoundCloud, TikTok, Instagram, and X links into MP3, WAV, or MP4 files with cover art and title tags. Free, no sign-up, no ads.",
  "studio.pitchShift": "Pitch",
  "studio.pitchMatch": "Match key ({delta} st)",
  "studio.pitchMatchHint": "Shift this clip so the keys mix",
  "studio.pitched": "Pitch shifted to {delta} st",
  "studio.demoButton": "Try a demo beat switch",
  "studio.keysButton": "Keys",
  "studio.keysSheetTitle": "Keyboard shortcuts",
  "studio.keysSelect": "Select next / previous clip",
  "studio.keysNudge": "Nudge the selected clip",
  "studio.keysSeek": "Jump to start / end",
  "studio.keysZoom": "Zoom in / out",
  "studio.close": "Close",
  "studio.matchOnGrid": "Already on the grid",
  "studio.crossfadeNeedsOverlap": "Overlap two clips to crossfade",
  "studio.presets": "Presets",
  "studio.presetClean": "Clean",
  "studio.exportName": "File name",
  "studio.renameTake": "Rename take",
  "studio.renameTakeHint": "Double-click to rename",
  "studio.takeLabel": "Take",
  "studio.format": "Format",
  "studio.export": "Export mix",
  "studio.exportDone": "Mix exported.",
  "studio.exportFailed": "Export failed — try removing a clip or shortening the timeline.",
  "studio.faq1Q": "How do I make a beat switch?",
  "studio.faq1A": "Drag the second song so it starts before the first one ends — both play through the overlap. Give the first song a fade-out (or cut it with S) right where the switch lands, and hit Record moves if you want to slow it down live at the moment it flips.",
  "studio.faq2Q": "Do the live effects end up in the export?",
  "studio.faq2A": "Yes. Press Record moves, perform your speed, reverb, and effect changes while it plays, and the take is replayed into the file when you export. Without a take, the export uses the current knob positions.",
  "studio.faq3Q": "Is anything uploaded?",
  "studio.faq3A": "No. Decoding, playback, mixing, and export all run in your browser. Your songs never leave your device.",
  "tools.cardDaw": "TuneBad DAW",
  "tools.descDaw": "Mix songs on a timeline: overlap, cut, and slow them down live.",
} as const;
