...
const zh: Record<keyof typeof en, string> = {
  ...
  "remix.effectRadio": "收音机",
  "remix.effectMegaphone": "扩音器",
  "remix.record": "录制",
  ...
  "remix.recordingReadyReadout": "已录制 · {time} · {count} 次操作",
  "remix.discardRecording": "放弃录制",
  ...
  "remix.exportRemixFormat": "导出混音 {format}",
