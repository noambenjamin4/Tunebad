...
export const metadata: Metadata = {
  title: "Resize Images for Instagram (Story, Post, Reel)",
  description:
  ...
  alternates: { canonical: "/resize-image-for-instagram", languages: languageAlternates("/resize-image-for-instagram") },
