// Localized variant of /audio-mastering: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/audio-mastering/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    titleKey: "meta.audioMastering.title",
    descriptionKey: "meta.audioMastering.description",
    ogImage: "/og/audio-mastering.png",
  });
}
