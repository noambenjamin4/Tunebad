// Localized variant of /heic-to-jpg: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/heic-to-jpg/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    path: "/heic-to-jpg",
    titleKey: "meta.heicToJpg.title",
    descriptionKey: "meta.heicToJpg.description",
    ogImage: "/og/heic-to-jpg.png",
  });
}
