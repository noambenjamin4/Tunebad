// Localized variant of /wav-to-mp3: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/wav-to-mp3/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    path: "/wav-to-mp3",
    titleKey: "meta.wavToMp3.title",
    descriptionKey: "meta.wavToMp3.description",
    ogImage: "/og/wav-to-mp3.png",
  });
}
