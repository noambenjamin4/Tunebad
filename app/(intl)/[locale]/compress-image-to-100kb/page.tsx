// Localized variant of /compress-image-to-100kb: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/compress-image-to-100kb/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    titleKey: "meta.compressImageTo100kb.title",
    descriptionKey: "meta.compressImageTo100kb.description",
  });
}
