// Localized variant of /camelot-wheel: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/camelot-wheel/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    path: "/camelot-wheel",
    titleKey: "meta.camelotWheel.title",
    descriptionKey: "meta.camelotWheel.description",
    ogImage: "/og/camelot-wheel.png",
  });
}
