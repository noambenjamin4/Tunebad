// Localized variant of /pitch-shifter: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/pitch-shifter/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    path: "/pitch-shifter",
    titleKey: "meta.pitchShifter.title",
    descriptionKey: "meta.pitchShifter.description",
    ogImage: "/og/pitch-shifter.png",
  });
}
