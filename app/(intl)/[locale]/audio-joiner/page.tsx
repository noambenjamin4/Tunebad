// Localized variant of /audio-joiner: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/audio-joiner/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    path: "/audio-joiner",
    titleKey: "meta.audioJoiner.title",
    descriptionKey: "meta.audioJoiner.description",
    ogImage: "/og/audio-joiner.png",
  });
}
