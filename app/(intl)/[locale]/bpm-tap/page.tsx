// Localized variant of /bpm-tap: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/bpm-tap/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    path: "/bpm-tap",
    titleKey: "meta.bpmTap.title",
    descriptionKey: "meta.bpmTap.description",
    ogImage: "/og/bpm-tap.png",
  });
}
