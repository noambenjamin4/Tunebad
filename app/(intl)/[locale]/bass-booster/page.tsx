// Localized variant of /bass-booster: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/bass-booster/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    path: "/bass-booster",
    titleKey: "meta.bassBooster.title",
    descriptionKey: "meta.bassBooster.description",
    ogImage: "/og/bass-booster.png",
  });
}
