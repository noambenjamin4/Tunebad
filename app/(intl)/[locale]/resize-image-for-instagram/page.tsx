// Localized variant of /resize-image-for-instagram: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/resize-image-for-instagram/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    titleKey: "meta.resizeImageForInstagram.title",
    descriptionKey: "meta.resizeImageForInstagram.description",
  });
}
