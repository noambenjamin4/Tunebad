// Localized variant of /resize-image: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/resize-image/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    path: "/resize-image",
    titleKey: "meta.resizeImage.title",
    descriptionKey: "meta.resizeImage.description",
    ogImage: "/og/resize-image.png",
  });
}
