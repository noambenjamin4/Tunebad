// Localized variant of /merge-pdf: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/merge-pdf/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    path: "/merge-pdf",
    titleKey: "meta.mergePdf.title",
    descriptionKey: "meta.mergePdf.description",
