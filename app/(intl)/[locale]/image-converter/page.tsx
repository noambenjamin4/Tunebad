// Localized variant of /image-converter: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/image-converter/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    titleKey: "meta.imageConverter.title",
    descriptionKey: "meta.imageConverter.description",
