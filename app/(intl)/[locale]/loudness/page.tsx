// Localized variant of /loudness: the SAME page component, re-exported, with
...
export { default } from "@/app/(en)/loudness/page";
...
export async function generateMetadata({
  ...
  return localizedPageMetadata({
    ...
    path: "/loudness",
    titleKey: "meta.loudness.title",
    descriptionKey: "meta.loudness.description",
    ogImage: "/og/loudness.png",
  });
}
